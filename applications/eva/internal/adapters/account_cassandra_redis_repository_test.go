...
func TestUserRepository_CreateUser_conflicting_username(t *testing.T) {
	...
	copyUsr, err := account.NewAccount(translations.NewLanguageWithFallback("en-US"), uuid.New().String(), usr.Username(), "test-email@test.com")
...
func TestUserRepository_CreateUser_conflicting_email(t *testing.T) {
	...
	copyUsr, err := account.NewAccount(translations.NewLanguageWithFallback("en-US"), uuid.New().String(), usr2.Username(), usr.Email())
...
func newFakeAccount(t *testing.T) *account.Account {
	...
	usr, err := account.NewAccount(translations.NewLanguageWithFallback("en-US"), uuid.New().String(), fake.Username, fake.Email)
