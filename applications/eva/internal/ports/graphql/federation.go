...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "AccountEmail":
			resolverName, err := entityResolverNameForAccountEmail(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "AccountEmail": %w`, err)
			}
			switch resolverName {
			...
			case "findAccountEmailByID":
				id0, err := ec.unmarshalNID2overdollᚋlibrariesᚋgraphqlᚋrelayᚐID(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findAccountEmailByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindAccountEmailByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "AccountEmail": %w`, err)
				}
		...
		case "AccountSession":
			resolverName, err := entityResolverNameForAccountSession(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "AccountSession": %w`, err)
			}
			switch resolverName {
			...
			case "findAccountSessionByID":
				id0, err := ec.unmarshalNID2overdollᚋlibrariesᚋgraphqlᚋrelayᚐID(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findAccountSessionByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindAccountSessionByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "AccountSession": %w`, err)
				}
...
func entityResolverNameForAccountEmail(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m  map[string]interface{}
			ok bool
		...
		return "findAccountEmailByID", nil
	}
	return "", fmt.Errorf("%w for AccountEmail", ErrTypeNotFound)
}

func entityResolverNameForAccountSession(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m  map[string]interface{}
			ok bool
		...
		return "findAccountSessionByID", nil
	}
	return "", fmt.Errorf("%w for AccountSession", ErrTypeNotFound)
}
