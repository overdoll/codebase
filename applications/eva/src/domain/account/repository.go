...
type Repository interface {
	...
	GetAccountUsernames(ctx context.Context, cursor *paging.Cursor, accountId string) ([]*Username, *paging.Info, error)
	...
	GetAccountEmails(ctx context.Context, cursor *paging.Cursor, accountId string) ([]*Email, *paging.Info, error)
