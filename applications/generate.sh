...
protoc --gql_out=paths=source_relative:./hades/schemas -I=. -I=./proto/books ./proto/books/*.proto
protoc --gql_out=paths=source_relative:./hades/schemas -I=. -I=./proto/holders ./proto/holders/*.proto