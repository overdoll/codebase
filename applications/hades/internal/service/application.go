...
func createApplication(ctx context.Context, eva query.EvaService, stella command.StellaService, carrier command.CarrierService, ccbillClient adapters.CCBillHttpClient, client client.Client) app.Application {
	...
	return app.Application{
		Commands: app.Commands{
			...
			GenerateProratedRefundAmountForAccountClubSubscription:           command.NewGenerateProratedRefundAmountForAccountTransactionHandler(billingRepo),
		...
		Queries: app.Queries{
			...
			AccountTransactionHistoryById:                     query.NewAccountTransactionByIdHandler(billingRepo),
