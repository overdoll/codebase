...
func createApplication(ctx context.Context, eva query.EvaService, stella command.StellaService, ccbillClient adapters.CCBillHttpClient, client client.Client) app.Application {
	...
	return app.Application{
		...
		Queries: app.Queries{
			...
			AccountClubSupporterSubscriptionsByAccount:        query.NewAccountClubSupporterSubscriptionsByAccountHandler(billingRepo),
			...
			AccountTransactionHistoryById:                     query.NewAccountTransactionHistoryByIdHandler(billingRepo),
			...
			SearchAccountTransactionHistory:                   query.NewSearchAccountTransactionHistoryHandler(billingRepo),
