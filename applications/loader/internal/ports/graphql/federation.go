...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "ResourceProgress":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "ResourceProgress": %w`, err)
			}
			switch resolverName {
			...
			case "findResourceProgressByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findResourceProgressByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindResourceProgressByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "ResourceProgress": %w`, err)
				}
...
func entityResolverNameForResourceProgress(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		...
		return "findResourceProgressByID", nil
	}
	return "", fmt.Errorf("%w for ResourceProgress", ErrTypeNotFound)
}
