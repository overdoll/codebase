...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Resource":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Resource": %w`, err)
			}
			switch resolverName {
			...
			case "findResourceByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findResourceByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindResourceByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Resource": %w`, err)
				}
...
func entityResolverNameForResource(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
