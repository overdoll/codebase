...
const SettingsCatalogs = [
  ...
  {
    path: 'src/domain/settings/profile/delete-account/__locale__/{locale}/index',
    include: ['src/domain/settings/profile/delete-account/']
  },
  {
...
const ClubCatalog = [
  ...
  {
    path: 'src/domain/club/revenue/payment/__locale__/{locale}/index',
    include: ['src/domain/club/revenue/payment/']
  },
  {
...
const ClubsCatalog = [
  ...
  {
    path: 'src/domain/clubs/invite-only/__locale__/{locale}/index',
...
const StaffCatalog = [
  ...
  {
    path: 'src/domain/staff/billing/deposit-requests/__locale__/{locale}/index',
    include: ['src/domain/staff/billing/deposit-requests/']
  },
  {
    path: 'src/domain/staff/billing/deposit-request/__locale__/{locale}/index',
    include: ['src/domain/staff/billing/deposit-request/']
  },
  {
    path: 'src/domain/staff/billing/payment/__locale__/{locale}/index',
    include: ['src/domain/staff/billing/payment/']
  },
  {
    path: 'src/domain/staff/billing/payout/__locale__/{locale}/index',
    include: ['src/domain/staff/billing/payout/']
  },
  {
  ...
  {
    path: 'src/domain/staff/entity/root/__locale__/{locale}/index',
    include: ['src/domain/staff/entity/root/']
  },
  {
