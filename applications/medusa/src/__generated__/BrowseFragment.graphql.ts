/**
 * @generated SignedSource<<8b986749da33522968d0b9efede1b6a0>>
...
export type BrowseFragment$data = {
  readonly postsFeed: {
  ...
  readonly " $fragmentType": "BrowseFragment";
};
export type BrowseFragment$key = {
  readonly " $data"?: BrowseFragment$data;
