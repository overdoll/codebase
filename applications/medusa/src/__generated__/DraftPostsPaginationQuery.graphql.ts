...
export type DraftPostsPaginationQuery = {
    readonly response: DraftPostsPaginationQueryResponse;
    readonly variables: DraftPostsPaginationQueryVariables;
};
...
fragment PostStateDraftFragment_2HEEH6 on Account {
