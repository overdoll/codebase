...
export type PublicClubPostsFragment = {
    readonly posts: {
    ...
    readonly id: string;
    readonly " $refType": "PublicClubPostsFragment";
};
export type PublicClubPostsFragment$data = PublicClubPostsFragment;
export type PublicClubPostsFragment$key = {
    readonly " $data"?: PublicClubPostsFragment$data | undefined;
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__PublicClubPosts_posts_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
