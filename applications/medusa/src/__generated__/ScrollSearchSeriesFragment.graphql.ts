/**
 * @generated SignedSource<<214ced9be49ccc32aa8b58a44a1ed775>>
...
export type ScrollSearchSeriesFragment$data = {
  readonly id: string;
  readonly posts: {
...
export type ScrollSearchSeriesFragment$key = {
  readonly " $data"?: ScrollSearchSeriesFragment$data;
