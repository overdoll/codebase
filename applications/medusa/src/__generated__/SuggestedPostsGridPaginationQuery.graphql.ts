...
export type SuggestedPostsGridPaginationQuery$variables = {
  after?: string | null;
  first?: number | null;
  id: string;
};
export type SuggestedPostsGridPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"ScrollGridSuggestedPostsFragment">;
  } | null;
};
export type SuggestedPostsGridPaginationQuery = {
  response: SuggestedPostsGridPaginationQuery$data;
  variables: SuggestedPostsGridPaginationQuery$variables;
};
