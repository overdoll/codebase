...
export type UploadSearchOriginalCharactersMultiSelectorPaginationFragment$variables = {
  after?: string | null;
  first?: number | null;
  id: string;
  name?: string | null;
...
export type UploadSearchOriginalCharactersMultiSelectorPaginationFragment = {
  response: UploadSearchOriginalCharactersMultiSelectorPaginationFragment$data;
  variables: UploadSearchOriginalCharactersMultiSelectorPaginationFragment$variables;
};
