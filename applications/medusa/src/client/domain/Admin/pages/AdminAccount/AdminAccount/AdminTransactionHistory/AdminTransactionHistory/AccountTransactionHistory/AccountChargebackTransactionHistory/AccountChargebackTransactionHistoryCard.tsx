...
import {
  AccountChargebackTransactionHistoryCardFragment$key
} from '@//:artifacts/AccountChargebackTransactionHistoryCardFragment.graphql'
...
interface Props {
  query: AccountChargebackTransactionHistoryCardFragment$key
}

const Fragment = graphql`
  fragment AccountChargebackTransactionHistoryCardFragment on AccountChargebackTransactionHistory {
    timestamp
    supportedClub {
      name
    }
...
export default function AccountChargebackTransactionHistoryCard ({
  query
}: Props): JSX.Element {
