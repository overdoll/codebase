...
import {
  AccountNewTransactionHistoryCardFragment$key
} from '@//:artifacts/AccountNewTransactionHistoryCardFragment.graphql'
...
interface Props {
  query: AccountNewTransactionHistoryCardFragment$key
}

const Fragment = graphql`
  fragment AccountNewTransactionHistoryCardFragment on AccountNewTransactionHistory {
    timestamp
    supportedClub {
      name
    }
...
export default function AccountNewTransactionHistoryCard
({
  query
}: Props): JSX.Element {
