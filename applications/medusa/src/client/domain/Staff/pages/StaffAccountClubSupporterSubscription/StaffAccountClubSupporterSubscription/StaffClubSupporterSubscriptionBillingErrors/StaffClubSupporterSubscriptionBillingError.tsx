...
import type {
  StaffClubSupporterSubscriptionBillingErrorFragment$key
} from '@//:artifacts/StaffClubSupporterSubscriptionBillingErrorFragment.graphql'
...
interface Props {
  query: StaffClubSupporterSubscriptionBillingErrorFragment$key
}

const Fragment = graphql`
  fragment StaffClubSupporterSubscriptionBillingErrorFragment on IAccountClubSupporterSubscription {
    billingError {
      ccbillDeclineError
      ccbillErrorCode
      ccbillErrorText
...
export default function StaffClubSupporterSubscriptionBillingError ({ query }: Props): JSX.Element {
