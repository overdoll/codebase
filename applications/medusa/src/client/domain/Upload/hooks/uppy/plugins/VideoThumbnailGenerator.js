/**
 * Stolen from https://github.com/SCRMHub/clientside-video-thumbnails/blob/master/videoThumbnails.js
 * so we don't have to download the package
 *
...
VideoThumbnails.prototype = {
  ...
  capture (file) {
    ...
    videoHtml.setAttribute('muted', true)
  ...
  initScreenshot () {
    ...
    if (this.thumbWidth > this.thumbHeight) {
      ...
      const ratio2 = this.opts.maxHeight / this.thumbHeight
      this.thumbHeight = this.opts.maxHeight
      this.thumbWidth = parseInt(this.thumbWidth * ratio2)
    }
