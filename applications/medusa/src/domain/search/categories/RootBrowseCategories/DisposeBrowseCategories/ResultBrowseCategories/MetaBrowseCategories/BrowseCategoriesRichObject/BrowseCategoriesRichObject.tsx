...
export default function BrowseCategoriesRichObject (): JSX.Element {
  const TITLE = `Browse Categories - ${SEARCH_TITLE_SUFFIX}`
  const DESCRIPTION = `${DESCRIPTION_CONTENT_DISCOVER} on ${SEARCH_TITLE_SUFFIX}.`

  const URL = 'https://overdoll.com/search/categories'
