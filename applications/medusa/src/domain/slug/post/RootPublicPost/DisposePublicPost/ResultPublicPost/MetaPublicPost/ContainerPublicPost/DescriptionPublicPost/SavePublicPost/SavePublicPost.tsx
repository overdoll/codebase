  ...
  return (
    <HStack spacing={1} justify='space-between' {...rest}>
      <Box pointerEvents='none' w='100%' p={1} overflow='hidden' position='relative' borderRadius='lg' h={10}>
        <HStack spacing={3} h='100%' align='center' justify='flex-start'>
          <Icon fill='whiteAlpha.300' icon={MagicBall} w={7} h={7} />
          <Box>
            <Heading fontSize='md' color='whiteAlpha.300'>
              <Trans>
                Save this post
              </Trans>
            </Heading>
            <Heading fontSize='xs' color='whiteAlpha.200'>
              <Trans>
