...
func NewPostAuditLogFilters(moderatorId, contributorId, postId string, dateRange []int) (*PostAuditLogFilters, error) {
...
func (e *PostAuditLogFilters) ContributorId() string {
