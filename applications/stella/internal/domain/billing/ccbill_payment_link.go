...
func encryptCCBillPaymentLink(paymentLink *stella.CCBillPaymentLink) (*string, error) {
...
func decryptCCBillPaymentLink(content string) (*stella.CCBillPaymentLink, error) {
	...
	newPaymentMessage := &stella.CCBillPaymentLink{}
