...
func (r *QueryResolver) Characters(ctx context.Context, after *string, before *string, first *int, last *int, slugs []string, name *string, orderBy types.CharactersOrder) (*types.CharacterConnection, error) {
...
func (r *QueryResolver) Character(ctx context.Context, slug string) (*types.Character, error) {
