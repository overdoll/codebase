...
func TestClubSupport(t *testing.T) {
	...
	clb := service.seedClub(t, uuid.New().String())
	...
	workflowExecution := testing_tools.NewMockWorkflowWithArgs(service.application.TemporalClient, workflows.NewSupporterPost, mock.Anything)
	...
	env := service.getWorkflowEnvironment()
