...
func (r *QueryResolver) PendingPosts(ctx context.Context, input types.ConnectionInput, filter types.PendingPostFilters) (*types.PendingPostConnection, error) {
	...
	return &types.PendingPostConnection{}, nil
}
