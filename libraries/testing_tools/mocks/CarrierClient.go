...
// NewMockCarrierClient creates a new instance of MockCarrierClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockCarrierClient(t testing.TB) *MockCarrierClient {
