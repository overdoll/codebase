...
// NewMockEvaClient creates a new instance of MockEvaClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEvaClient(t testing.TB) *MockEvaClient {
	mock := &MockEvaClient{}
	mock.Mock.Test(t)
