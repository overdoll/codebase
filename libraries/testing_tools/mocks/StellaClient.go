...
// NewMockStellaClient creates a new instance of MockStellaClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockStellaClient(t testing.TB) *MockStellaClient {
