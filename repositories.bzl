...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:kwMX8Upw8Wc0+NGEolXk9/qRVnbRps6lq3+3ml3PSZs=",
        version = "v0.14.1-0.20220105021018-47015f12e3aa",
    )
    ...
    go_repository(
        ...
        sum = "h1:o+I1ZK9jASakMyIMRN03rMaExKNicWebBSTrCSj55hs=",
        version = "v1.5.0",
    )
    go_repository(
        ...
        sum = "h1:QkqOpmgXVnHHCFP9HbSbyrF3jYgLBKY/3NdZyR7e5nQ=",
        version = "v1.12.0",
    )
